...
class SaveProductRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'price2' => 'required|numeric|min:0|max:99999999999999',
            'special_price' => 'nullable|numeric|min:0|max:99999999999999',
            'KG' => 'nullable|numeric|min:0|max:99999999999999',
            'pesoV' => 'nullable|numeric|min:0|max:99999999999999',
            'costo' => 'nullable|numeric|min:0|max:99999999999999',
